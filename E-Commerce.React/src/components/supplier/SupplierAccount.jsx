      ...
      <div className="">
        <div className="supplier-panel row flex-column flex-lg-row m-0">
          <div className="supplier-header col-12 col-lg-2 d-flex flex-row flex-lg-column p-0">
            ...
            <p className="d-block d-lg-none text-center fw-semibold mb-2 text-danger">Satıcı panelinde daha iyi bir deneyim için lütfen masaüstü cihazdan giriş yapın</p>
