    ...
    <>
      <div className="features border-bottom border-muted">
        <div className="container d-flex flex-column flex-lg-row justify-content-between">
          <div className="d-flex align-items-center py-5 features-item col-12 col-lg-4 justify-content-start justify-content-lg-center">
            <div className="icon">
            ...
            <div className="ps-4">
              ...
              <p className="text-white fw-light fs-6">$500 Üstü alışverişlerinizde</p>
            </div>
          </div>
          <div className="d-flex align-items-center py-5 features-item col-12 col-lg-4 justify-content-start justify-content-lg-center">
            <div className="icon">
            ...
            <div className="ps-4">
              ...
              <p className="text-white fw-light fs-6">14 Gün iade hakkı</p>
            </div>
          </div>
          <div className="d-flex align-items-center py-5 features-item col-12 col-lg-4 justify-content-start justify-content-lg-center">
            <div className="icon">
            ...
            <div className="ps-4">
              ...
              <p className="text-white fw-light fs-6">10.000'den fazla ürün</p>
            </div>
          </div>
        </div>
      </div>
